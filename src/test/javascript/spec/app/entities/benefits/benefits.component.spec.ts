...
import { BenefitsComponent } from 'app/entities/benefits/benefits.component';
...
describe('Component Tests', () => {
    describe('Benefits Management Component', () => {
        let comp: BenefitsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BenefitsComponent, '')
                .compileComponents();
