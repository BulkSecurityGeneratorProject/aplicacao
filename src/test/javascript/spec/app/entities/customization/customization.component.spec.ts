...
import { CustomizationComponent } from 'app/entities/customization/customization.component';
...
describe('Component Tests', () => {
    describe('Customization Management Component', () => {
        let comp: CustomizationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CustomizationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.customizations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
