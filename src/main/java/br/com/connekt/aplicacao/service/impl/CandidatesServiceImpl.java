...
import br.com.connekt.aplicacao.service.CandidatesService;
import br.com.connekt.aplicacao.domain.Candidates;
import br.com.connekt.aplicacao.repository.CandidatesRepository;
import br.com.connekt.aplicacao.service.dto.CandidatesDTO;
import br.com.connekt.aplicacao.service.mapper.CandidatesMapper;
...
public class CandidatesServiceImpl implements CandidatesService {
    ...
    public CandidatesServiceImpl(CandidatesRepository candidatesRepository, CandidatesMapper candidatesMapper) {
    ...
    public CandidatesDTO save(CandidatesDTO candidatesDTO) {
        ...
        return candidatesMapper.toDto(candidates);
    }
