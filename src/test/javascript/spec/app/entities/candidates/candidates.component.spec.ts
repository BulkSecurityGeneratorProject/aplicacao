...
import { CandidatesComponent } from 'app/entities/candidates/candidates.component';
...
describe('Component Tests', () => {
    describe('Candidates Management Component', () => {
        let comp: CandidatesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CandidatesComponent, '')
                .compileComponents();
