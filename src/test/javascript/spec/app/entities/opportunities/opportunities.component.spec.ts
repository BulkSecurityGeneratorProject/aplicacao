...
import { OpportunitiesComponent } from 'app/entities/opportunities/opportunities.component';
...
describe('Component Tests', () => {
    describe('Opportunities Management Component', () => {
        let comp: OpportunitiesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OpportunitiesComponent, '')
                .compileComponents();
