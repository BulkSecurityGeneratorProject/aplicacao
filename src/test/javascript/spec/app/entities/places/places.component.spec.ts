...
import { PlacesComponent } from 'app/entities/places/places.component';
import { PlacesService } from 'app/entities/places/places.service';
import { Places } from 'app/shared/model/places.model';

describe('Component Tests', () => {
    describe('Places Management Component', () => {
        let comp: PlacesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PlacesComponent, '')
                .compileComponents();
