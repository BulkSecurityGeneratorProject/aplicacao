...
import { MatchingsComponent } from 'app/entities/matchings/matchings.component';
...
describe('Component Tests', () => {
    describe('Matchings Management Component', () => {
        let comp: MatchingsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MatchingsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.matchings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
