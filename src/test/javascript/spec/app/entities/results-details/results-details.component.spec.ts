...
import { ResultsDetailsComponent } from 'app/entities/results-details/results-details.component';
...
describe('Component Tests', () => {
    describe('ResultsDetails Management Component', () => {
        let comp: ResultsDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ResultsDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.resultsDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
