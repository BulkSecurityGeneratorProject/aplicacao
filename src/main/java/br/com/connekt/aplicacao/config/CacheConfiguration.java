package br.com.connekt.aplicacao.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("aplicacao");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("aplicacao");
        ...
        config.getMapConfigs().put("br.com.connekt.aplicacao.domain.*", initializeDomainMapConfig(jHipsterProperties));
